function updateDefaults() {
    ...
    if (modelSelect == "0") {
        ...
        document.getElementById("frompredict").value = "type your prediction";
        document.getElementById("node0input").value = "type your 0 ";
        document.getElementById("node1input").value = "type your 1";
